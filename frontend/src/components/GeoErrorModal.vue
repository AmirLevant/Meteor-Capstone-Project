<template>
<div class="h-screen absolute w-full z-[50] flex justify-center items-start pt-[125px] bg-black/50">
    <div class="flex flex-col bg-white w-[80%] sm:w-[450px] px-6 py-4 rounded-md">
        <h1 class="text-lg mb-1">Error: {{ geoErrorMsg }}</h1>
        <p class="text-sm mb-4">
            To take advantage of this application's features, please ensure location services are enabled
        </p>
        <button 
